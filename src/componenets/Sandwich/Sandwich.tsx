...
<button type="button" onClick={handleAddBacon} className={style.btn}>Add bacon</button>
<button type="button" onClick={handleAddSalad} className={style.btn}>Add salad</button>
