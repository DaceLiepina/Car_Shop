  ...
  resetForm(); // <-- Šī rindiņa attīra laukus pēc submit
    ...
    <ErrorMessage> отображает ошибки для указанного поля. */}
            ...
            <div className={styles.formGroup}>
                ...
                <Field id="name" name="name" placeholder="Enter the name" className={styles.input} />
                <ErrorMessage name="name" component="div" className={styles.error} />
            </div>

            <div className={styles.formGroup}>
                <label htmlFor="email">Email</label>
                <Field id="email" name="email" placeholder="Enter the email" className={styles.input} />
                <ErrorMessage name="email" component="div" className={styles.error} />
            </div>

            <div className={styles.formGroup}>
                <label htmlFor="message">Message</label>
                <Field as="textarea" id="message" name="message" placeholder="Enter the message" className={styles.input} />
                <ErrorMessage name="message" component="div" className={styles.error} />
            </div>
            <button type="submit" className={styles.submitBtn}>To send</button>
            </Form>
            </Formik>
        </div>
        </div>
